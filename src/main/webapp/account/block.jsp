...
<head>
    ...
    <title>Block account | Payments system</title>
</head>
            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item dropdown active">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuAccount">
                        ...
                        <span class="dropdown-item active">Block account</span>
                    </div>
                </li>
                <li class="nav-item">
...
<div class="container">
    <div class="row justify-content-center">
        <form class="base-form" method="post" action="/account/block">
            ...
            <div class="form-group text-danger">
                Warning! You are about to block your account.
                <br>
                Note that only administrator can unblock it.
            </div>
            <div class="form-group">
                <button type="submit" class="btn btn-block btn-danger shadow rounded">Block account</button>
            </div>
        </form>
    </div>
</div>
